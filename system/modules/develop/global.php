...
.global {width:500px;margin:0 auto;border: 1px solid #ADC4DF;background:#DEECF7;margin-top:50px;padding:10px;}
.global div{margin:0 auto;padding:15px;}
.left-span {width: 180px;display: inline-block;}
.global .content{height:150px;margin:10px auto;color:#F61E2F;font-size:15px;text-align:center;}
.global .content form{color:initial;text-align:left;}
