...
return array(
    ...
    'fault_static_route'               => array(2304, '静态生成路由配置有误，应包含{controller}控制器，{action}动作，{params}查询字符串，并且以斜杠“/”或横杠“{delimiter}”分隔，如：{controller}/{action}{delimiter}{params}。'),
    ...
    'not_exists_model_class'           => array(2417, '模型类不存在！%s'),
    ...
    'no_extension'                     => array(2516, '无法加载%s扩展，请检查该扩展是否安装和启动！'),
    'no_action_return'                 => array(2517, '指定的action类没有可返回函数，无法返回值！'),
    'no_open_service_config'           => array(2518, '%s扩展或服务被禁止使用，请在应用的配置文件中开启。'),
    'no_session_save_time'             => array(2519, 'Session保存时间未设置！'),
    'no_rewrite_default_file'          => array(2520, '伪静态默认配置文件丢失！'),
    'no_fields'                        => array(2521, '无法获取字段信息，请检查数据表及其权限是否存在'),
    'no_plugin'                        => array(2522, '类插件不存在或为空！'),
    'no_session_path'                  => array(2523, 'Session目录不存在或缺少目录新建权限！'),
    'no_dir_write_perm'                => array(2524, '目录没有写权限！'),
    'no_file_write_perm'               => array(2525, '文件没有写权限！'),
    'no_file_read_perm'                => array(2526, '文件没有读权限！'),
    'no_service'                       => array(2527, '服务不存在：%s'),
