...
<?php ocImport(OC_SYS . 'modules/develop/css/index.php');?>
<style type="text/css">
#main{width:100%;}
.content{height:100%;padding:15px 25px;background:#F7FBFC;width:100%;margin:0;}
.title{font-weight:bold;height:35px;color:#225985;}
.oc-error{font-weight:bold;color:#f33;}
.oc-exception{font-weight:bold;color:#f63;}
.oc-message{font-weight:normal;font-size:15px;padding-top:5px;}
</style>
</head>
<body>
<div id="header">
